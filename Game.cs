    ...
    public class Game
    {
        ...
        private string determineWinner()
        {
            ...
            if (_player1.Cards.Count > _player2.Cards.Count)
                result += "<br/><span style='color:green;font-weight:bolder;'>Player 1 wins</span>";
            else
                result += "<br/><span style='color:green;font-weight:bolder;'>Player 2 wins</span>";
                
            result += "<br/><span style='color:red;font-weight:bolder;'>Player 1:" + _player1.Cards.Count +
                "</span><br/><span style='color:blue;font-weight:bolder;'>Player2:" + _player2.Cards.Count + "</span>";
            return result;
        }
